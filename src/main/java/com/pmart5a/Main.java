...
блокировок хорошее быстродействие и её емкость ограничена только доступной оперативной памятью (ОП). При большом
...
Queue и имеющая приемлемое быстродействие. У данной коллекции можно задать ёмкость, что при недостаточном количестве
